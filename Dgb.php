	...
	<br>
			<div class="container">
			     <div class="row">
			         ...
			         <div class="col-md-7">
			          <img src="images/DGB.png" width="600" height="300">
			         </div>

			         <div class="col-md-5">
			            <h3>Recopilacion de libros digitales DGB</h3>
			            
						<p>La DGB tiene como objetivos, apoyar la modernización de los espacios, acervos y servicios de las bibliotecas públicas de la Red Nacional . . . La Dirección General de Bibliotecas (DGB) surge en 1985 por un acuerdo del entonces secretario de Educación Pública, Jesús Reyes Heroles.</p>
						<br>	<a href="https://eds.s.ebscohost.com/eds/search/basic?vid=0&sid=6cbdb998-ef86-4c6b-ac2f-2edb517303f3%40redis" class="btn btn-primary stretched-link">Ir a coleccion Digital DGB</a>
					</div>
