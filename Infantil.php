	...
	<br>
			<div class="container">
			     <div class="row">
			         ...
			         <div class="col-md-7">
			          <img src="images/infantil.png" width="600" height="450">
			         </div>

			         <div class="col-md-5">
			            <h3>Recopilacion de libros infantiles</h3>
		
						<br><p>Esta colección, que comenzó en 2002, tiene el propósito de acercar a las nuevas generaciones, de una forma lúdica y atractiva, a la vida y obra de autores imprescindibles en el panorama de la literatura universal.
						Asimismo, anualmante, por medio de talleres de lectura y dibujo, se ha incentivado la cretividad e imaginación de los niños residentes en todas las entidades del país, cuyos trabajos, mediante concurso, han sido seleccionados para ilustrar estas ediciones.
						</p>	<a href="https://dgb.cultura.gob.mx/info_dgb.php?id=100" class="btn btn-primary stretched-link">Ir a coleccion infantil</a>
					</div>
			...
			<!--Menu lateral Izquierdo-->
				...
				<div class="col-sm-9 padding-right">
                    ...
                    <div class="features_items">
						<h2 class="title text-center">Libros Disponibles aqui</h2>
						 <?php
