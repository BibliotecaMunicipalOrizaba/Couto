...
<html lang="en">
                ...
                <div class="navbar-collapse collapse">							
					<div class="menu">
						<ul class="nav nav-tabs" role="tablist">
							...
							<li role="presentation"><a href="about.php"class="active">¿QUIENES SOMOS?</a></li>
  ...
  <tr>
    <td bgcolor="#3F9CD8">PLANTA ALTA</td>
  </tr>
  <tr>
	<td bgcolor="#3F9CD8">Área Digital: Aula Telmex y Sala General de computo
Espacios rentables dentro de la biblioteca.
</td>
  </tr>
  
  <tr>
  <td bgcolor="#3F9CD8">Auditorio “JOAQUÌN ARRONIZ “: capacidad de 50 personas (por pandemia solo 30)</td>
  </tr>
  <tr>
    <td bgcolor="#3F9CD8">Salón con capacidad de 15 personas para la realización de cursos, conferencias, presentaciones de libro </td>
  </tr>
</table>
				  ...
				  -->
				  <iframe width="360" height="195" src="https://www.youtube.com/embed/-jySiXwRJE0?start=5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
							...
							<div class="media">
								...
								<div class="media-body">
									...
									<ul class="tag clearfix">
										<li class="btn"><a href="#">Encargada</a></li>
									</ul>
						...
						<div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
							<div class="media">
								...
								<div class="media-body">
									...
									<h5>Auxiliar</h5>
									<ul class="tag clearfix">
										<li class="btn"><a href="#">Auxiliar</a></li>
									</ul>
									<ul class="social_icons">
										<li><a href="#"><i class="fa fa-facebook"></i></a></li>
										<li><a href="#"><i class="fa fa-twitter"></i></a></li> 
				...
				<div class="row clearfix">   
					<div class="col-md-4 col-sm-6 col-md-offset-2">	
						<div class="single-profile-bottom wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="600ms">
							...
							<p>"Muy tristes y solitarios,en la estantería los libros se encuentran,con voces silenciosas hacen comentarios,
							pero por ello no protestan.Esperan con mucha paciencia,que los usuarios los presten,para hablarles de toda su ciencia,
					...
					<div class="col-md-4 col-sm-6 col-md-offset-2">
						<div class="single-profile-bottom wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="600ms">
							...
							Sabor inigualable de victoria,glorioso es el poder que te da el libro."</p>
						</div>
					</div>
				</div>	<!--/.row-->
