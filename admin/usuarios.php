...
if(isset($_SESSION['user']))//hay que cambiar el nombre de los campos de la consulta 
 {?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="container-fluid">
             <br>
                ...
                <center><h1 class="page-header">
                            <small><img src="images/logo.png"class="img-responsive" width="200" height="200"></small>Administradores del sistema
                        </h1></center>
                <!-- /.row -->
    <section>
    <table border="0" align="left">
        <tr>
        <td style="margin-rigth:20px;"><B> Buscar Administrador: </B></td>
        <td>&nbsp; &nbsp;</td>
        <td width="335"><input type="text" placeholder="Busca por Nombre" id="bs-prod" style="border-radius:10px; padding-left:5px; heigth:25px; width:90%" /></td>
            ...
            <td></td>
            <td></td>
            <td width="100"><button id="nuevo-producto" class="btn btn-success">Nuevo Administrador</button></td>
            <td>&nbsp; &nbsp;</td>
            <!-- este boton es una idea <td width="200"><a target="_blank" href="javascript:reportePDF();" class="btn btn-primary">Exportar PDF</a></td>-->
        </tr>
    </table>
    </section>
 <br>
