                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h2 class="page-header">
                            <small><img src="images/logo.png" class="img-responsive" width="200" height="200"></small> Listado de Prestamos
                        </h2></center>
                    </div>
                </div>
                <!-- /.row -->
  ...
  while($registro2 = mysqli_fetch_assoc($registro)){
   ...
   switch($estado){
    ...
    echo'>
      ...
      if(($estado)==1){
        echo'
     <td><a href="prestamos_libros/BOTONPRESTAR.php?id='.$registro2['prestamo'].'"><button class="btn btn-danger btn-xs">Prestar</button></a></td>
</tr>';
}
