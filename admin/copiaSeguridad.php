...
//https://www.youtube.com/watch?v=ZRGwdhtaIQU
 {?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="container-fluid">
             <br>
                ...
                <h1 class="page-header">
                            <small><img src="images/logo.png" class="img-responsive" width="200" height="200"></small> Copia de Seguridad
                        </h1></center>
                <!-- /.row -->
    <section>
              <?php
