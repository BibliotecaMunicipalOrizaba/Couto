	...
	<br>
			<div class="container">
			     <div class="row">
			         ...
			         <div class="col-md-7">
			          <img src="images/BibliotecaVirtual.png" width="600" height="300">
			         </div>

			         <div class="col-md-5">
			            <h3>Acervo Biblioteca Virtual de Mexico</h3>
			            
						<p>La Dirección General de Bibliotecas ofrece al público el acceso a su Biblioteca Virtual de México, en la que se cuenta con un acervo digital de más de 13,243 recursos entre libros, folletos y otros documentos de interés histórico y literario. Entre las obras disponibles, se encuentran: "Los empeños de una casa", de Sor Juana Inés de la Cruz, "Clemencia", de Ignacio Manuel Altamirano y "Castillos en el Aire y otros textos mordaces", de Francisco Zarco.</p>
						<br>	<a href="https://bibliotecavirtualdemexico.cultura.gob.mx/" class="btn btn-primary stretched-link">Ir a Biblioteca Virtual de Mexico</a>
					</div>
